; Note: Put your custom routine/data macros, references to them, and defines in this file from within the KDL3_InsertIntegratedPatches and KDL3_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro KDL3_InsertIntegratedPatches()
...
macro KDL3_ApplyPatchesPostAssembly()
